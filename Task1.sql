...
-- Получить список студентов, зачисленных после первогдо сентября 2012 гопеа на первый курс очной формы обучения (сциальность: 230101).
...
where "Н_НАПРАВЛЕНИЯ_СПЕЦИАЛ"."НС_ИД" IN (
